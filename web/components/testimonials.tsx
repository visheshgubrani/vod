      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <div className="bg-mauve-600/40 px-4  py-2 flex items-center gap-2 inline-flex rounded-full border-mauve-300/25 border mb-6">
            ...
            <span className="text-sm">Loved by developers</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Trusted by <span className="gradient-text">Thousands</span> of Teams
          </h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            From startups to enterprises, developers choose ClipMux for
            reliable, affordable video streaming.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="glass card-bg rounded-2xl p-8 hover:scale-[1.02] transition-transform"
            >
              {/* Stars */}
        ...
        {/* Stats Banner */}
        <div className="mt-16 glass card-bg rounded-3xl p-8 md:p-12">
