                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-xl bg-muted/30 border border-border">
                                    ...
                                    <p className={cn("font-medium capitalize", statusColors[video.status] || "text-foreground")}>
                                        {video.status}
                                    </p>
                                </div>
                                <div className="p-4 rounded-xl bg-muted/30 border border-border">
                                    <p className="text-xs text-muted-foreground mb-1">Playback Policy</p>
                                    {isEditing ? (
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    <code className="flex-1 p-3 rounded-lg bg-muted/30 border border-border font-mono text-sm text-foreground">
                                        {video.id}
                                    </code>
                                    <Button
                                        size="sm"
